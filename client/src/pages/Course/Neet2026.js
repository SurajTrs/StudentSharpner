...
const neetTwoYearCourses = [
  {
    title: "Pragati NEET 2026 – 1-Year Program (Hinglish)",
  ...
  {
    title: "Pragati NEET 2026 – 1-Year Program (Hindi)",
  ...
  return (
    <div className="jee-page">
      <main className="jee-main">
        <p className="breadcrumb">🏠 Home / NEET / 1-Year Program</p>
        <h1 className="jee-title">NEET 2026 – 1-Year Program (Class 11 + 12)</h1>
        <p className="desc">
          Start early with our 1-Year NEET Program for students entering Class 11. Get complete coverage of Physics, Chemistry, and Biology, personalized mentorship, mock tests, and more to ace NEET 2026.
        </p>
      ...
      <section className="jee-batches">
        <h2>1-Year NEET Foundation Batches</h2>
